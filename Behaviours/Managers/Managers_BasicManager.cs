...
public class BoxManager : PlacementHandling
{
    ...
    public void Awake()
    {
        SandboxSpawnRegistry.Register("Box", (point, normal, args) => SpawnBoxObject(point, normal, (bool)args[0]));
    }
    ...
    public override void Activated(RaycastHit hitInfo)
    {
        ...
        GameObject Box = SpawnBoxObject(hitInfo.point, hitInfo.normal, IsPlane);
        SandboxNetworking.BroadcastSpawn(Box, "Box", hitInfo.point, hitInfo.normal, new object[] { IsPlane });
    }
    
    public static GameObject SpawnBoxObject(Vector3 point, Vector3 normal, bool isPlane)
    {
        ...
        Box.transform.SetParent(RefCache.SandboxContainer.transform, false);
...
public class SphereManager : PlacementHandling
{
    ...
    public void Awake()
    {
        SandboxSpawnRegistry.Register("Sphere", (point, normal, args) => SpawnSphereObject(point, normal, (int)args[0]));
    }
    ...
    public override void Activated(RaycastHit hitInfo)
    {
        ...
        int variant = IsSoftbody ? 1 : (IsEnemy ? 2 : 0);
        GameObject obj = SpawnSphereObject(hitInfo.point, hitInfo.normal, variant);
        SandboxNetworking.BroadcastSpawn(obj, "Sphere", hitInfo.point, hitInfo.normal, new object[] { variant });
    }

    public GameObject SpawnSphereObject(Vector3 point, Vector3 normal, int variant)
    {
        if (variant == 0)
        {
            ...
            Ball.transform.SetParent(RefCache.SandboxContainer.transform, false);
...
public class BeanManager : PlacementHandling
{
    ...
    public void Awake()
    {
        SandboxSpawnRegistry.Register("Bean", (point, normal, args) => SpawnBeanObject(point, normal, (int)args[0]));
    }
    ...
    public override void Activated(RaycastHit hitInfo)
    {
        ...
        int variant = IsBarrel ? 0 : (IsWheel ? 1 : 2);
        GameObject obj = SpawnBeanObject(hitInfo.point, hitInfo.normal, variant);
        SandboxNetworking.BroadcastSpawn(obj, "Bean", hitInfo.point, hitInfo.normal, new object[] { variant });
    }

    public GameObject SpawnBeanObject(Vector3 point, Vector3 normal, int variant)
    {
        if (variant == 0)
        {
            ...
            Bean.transform.SetParent(RefCache.SandboxContainer.transform, false);
...
public class BathManager : PlacementHandling
{
    ...
    public void Awake()
    {
        SandboxSpawnRegistry.Register("Bath", (point, normal, args) => SpawnBathObject(point, normal));
    }
    ...
    public override void Activated(RaycastHit hitInfo)
    {
        ...
        GameObject obj = SpawnBathObject(hitInfo.point, hitInfo.normal);
        SandboxNetworking.BroadcastSpawn(obj, "Bath", hitInfo.point, hitInfo.normal, null);
    }

    public GameObject SpawnBathObject(Vector3 point, Vector3 normal)
    {
        ...
        BathObject.transform.SetParent(RefCache.SandboxContainer.transform, false);
...
public class CrateManager : PlacementHandling
{
    ...
    public void Awake()
    {
        SandboxSpawnRegistry.Register("Crate", (point, normal, args) => SpawnCrateObject(point, normal));
    }
    ...
    public override void Activated(RaycastHit hitInfo)
    {
        ...
        GameObject obj = SpawnCrateObject(hitInfo.point, hitInfo.normal);
        SandboxNetworking.BroadcastSpawn(obj, "Crate", hitInfo.point, hitInfo.normal, null);
    }

    public GameObject SpawnCrateObject(Vector3 point, Vector3 normal)
    {
        ...
        CrateObject.transform.SetParent(RefCache.SandboxContainer.transform, false);
...
public class CouchManager : PlacementHandling
{
    ...
    public void Awake()
    {
        SandboxSpawnRegistry.Register("Couch", (point, normal, args) => SpawnCouchObject(point));
    }
    ...
    public override void Activated(RaycastHit hitInfo)
    {
        ...
        GameObject obj = SpawnCouchObject(hitInfo.point);
        SandboxNetworking.BroadcastSpawn(obj, "Couch", hitInfo.point, hitInfo.normal, null);
    }

    public GameObject SpawnCouchObject(Vector3 point)
    {
        ...
        CouchObject.transform.SetParent(RefCache.SandboxContainer.transform, false);
