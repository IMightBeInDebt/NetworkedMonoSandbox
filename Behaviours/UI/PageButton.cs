...
namespace MonoSandbox.Behaviours.UI
{
    public class PageButton : MonoBehaviour
    {
        ...
        public void Start()
        {
            ...
            gameObject.GetComponent<Renderer>().material.color = _active ? ThemeManager.PageButtonColor1 : ThemeManager.PageButtonColor2;
        ...
        public void Update()
        {
            ...
            if (_active != isActive)
            {
                ...
                _flipping = true;
                _time = Mathf.PI * -0.5f;
                _flipColour = isActive ? ThemeManager.PageButtonColor1 : ThemeManager.PageButtonColor2;
            }
