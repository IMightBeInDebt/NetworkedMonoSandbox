...
namespace MonoSandbox.Behaviours.UI
{
    public class Button : MonoBehaviour
    {
        ...
        public void Start()
        {
                _active = _list._currentPage == 0 && _list.objectButtons[_buttonIndex] || _list._currentPage == 1 && _list.weaponButtons[_buttonIndex] || _list._currentPage == 2 && _list.toolButtons[_buttonIndex] || _list._currentPage == 3 && _list.utilButtons[_buttonIndex] || _list._currentPage == 4 && _list.settingsButtons[_buttonIndex] || _list._currentPage == 5 && _list.modsButtons[_buttonIndex];
            gameObject.GetComponent<Renderer>().material.color = _active ? ThemeManager.ItemButtonColor1 : ThemeManager.ItemButtonColor2;
        ...
        public void Update()
        {
            bool isActive = (_list._currentPage == 0 && _list.objectButtons[_buttonIndex]) || (_list._currentPage == 1 && _list.weaponButtons[_buttonIndex]) || (_list._currentPage == 2 && _list.toolButtons[_buttonIndex]) || (_list._currentPage == 3 && _list.utilButtons[_buttonIndex]) || (_list._currentPage == 4 && _list.settingsButtons[_buttonIndex]) || (_list._currentPage == 5 && _list.modsButtons[_buttonIndex]);
            ...
            if (_active != isActive)
            {
                ...
                _flipping = true;
                _time = Mathf.PI * -0.5f;
                _flipColour = isActive ? ThemeManager.ItemButtonColor1 : ThemeManager.ItemButtonColor2;
            }
